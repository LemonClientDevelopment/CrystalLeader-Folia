...
public abstract class MyCommand extends Command {
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String commandLabel, String[] args) {
        ...
        if (!CrystalLeader.INSTANCE.isEnabled()) {
            throw new CommandException("Cannot execute command '" + commandLabel + "' in plugin " + CrystalLeader.INSTANCE.getDescription().getFullName() + " - plugin is disabled.");
        }
        ...
        try {
            ...
            throw new CommandException("Unhandled exception executing command '" + commandLabel + "' in plugin " + CrystalLeader.INSTANCE.getDescription().getFullName(), ex);
        }
    ...
    public @NotNull List<String> tabComplete(@NotNull CommandSender sender, @NotNull String alias, String[] args, Location location) throws IllegalArgumentException {
        ...
        try {
            ...
            message.deleteCharAt(message.length() - 1).append("' in plugin ").append(CrystalLeader.INSTANCE.getDescription().getFullName());
